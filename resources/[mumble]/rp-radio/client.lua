...
Radio.Commands = {
    {
        ...
        Help = "Alternar radio", -- Command help shown in chatbox when typing the command
        Params = {},
    ...
    },
    {
        ...
        Help = "Cambiar frecuencia", -- Command help shown in chatbox when typing the command
        Params = {
            {name = "number", "Ingresar frecuencia"}
        },
        Handler = function(src, args, raw)
            if Radio.Has then
                if args[1] then
