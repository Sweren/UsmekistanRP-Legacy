...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Corto"}, -- Whisper speech distance in gta distance units
		{8.0, "Normal"}, -- Normal speech distance in gta distance units
		{20.0, "Largo"}, -- Shout speech distance in gta distance units
	},
	...
	radioClickMaxChannel = 4, -- Set the max amount of radio channels that will have local radio clicks enabled
