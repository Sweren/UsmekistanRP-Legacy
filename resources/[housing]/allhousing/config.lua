-- Rare5M https://discord.gg/SnjQkm  
...
Config = {
  ...
  ["BankAccountName"]   = "tricoins",
  ["DirtyAccountName"]  = "tricoins",
  ["CashAccountName"]   = "tricoins",        -- ignore if not using esx v.1.2 + 
  ...
  CreationJobs = {   
    police = {                        -- JOB NAME.
      ...
      payCut  = 100,                    -- % of sale earnt by player, rest goes to realestate society account (if using esx_society, else goes nowhere).
    },
    realestate = {                    -- JOB NAME.
