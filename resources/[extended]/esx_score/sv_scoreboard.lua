...
RegisterServerEvent("esx_score:getIsAllowed")
AddEventHandler("esx_score:getIsAllowed", function()
    if IsPlayerAceAllowed(source, "esx_score.admin") then
        TriggerClientEvent("esx_score:returnIsAllowed", source, true)
    else
        TriggerClientEvent("esx_score:returnIsAllowed", source, false)
    end
end)
