...
--[[ Threads ]]
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            -- Trigger Opens Menu
            if IsControlPressed(1, 19) and IsControlJustPressed(1, 188) then
                TriggerServerEvent("K9:RequestOpenMenu")
            end

            -- Trigger Attack
            if IsControlJustPressed(1, 187) and IsPlayerFreeAiming(PlayerId()) then
            ...
            -- Trigger Follow
            if IsControlJustPressed(1, 189) and not IsPlayerFreeAiming(PlayerId()) then
