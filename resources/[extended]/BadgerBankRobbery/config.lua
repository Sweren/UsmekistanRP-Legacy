config = {
	robberyReward = math.random(200000,500000),

	timeToRob = 60, -- In seconds
	robberyCooldown = 15, -- In minutes
	robbingStr = "Robando el banco...",
	...
	robberySuccess = "^2^*El robo ha sido completado. ^5^rEl proximo robo podra ser activado en ^1^*15 ^5^rminutos.",
	robberyFailed = "^1^*El robo ha sido fallido. ^5^rEl proximo robo podra ser activado en ^1^*15 ^5^rminutos",

	bankcoords = {
		{name = "Robo de banco paleto bay", alarm = "^1^*Se ha disparado una alarma en el ^5banco del condado de Blaine en Paleto Bay^1! ¡Todas las unidades de policía deben ayudar!", 
		x = -104.42, y = 6476.56, z=32.51-1.7},

		{name = "Robo de banco harmony", alarm = "^1^*Se ha disparado una alarma en el ^5Banco Fleeca Harmony en Harmony^1! ¡Todas las unidades de policía deben ayudar!", 
		x = 1177.32, y = 2711.79, z = 38.1 - 1},

		{name = "Banham Canyon Bank Robbery", alarm = "^1^*Se ha disparado una alarma en el ^5Banco en Banham Canyon^1! ¡Todas las unidades de policía deben ayudar!", 
		x = -2957.5, y = 480.97, z = 15.71 - 1},

		{name = "Pillbox Hill Bank Robbery", alarm = "^1^*Se ha disparado una alarma en el ^5Banco en Pillbox Hill^1! ¡Todas las unidades de policía deben ayudar!", 
