...
Config.NPCJobEarnings             = {min = 1200, max = 1800}
...
Config.taxiStations = {
	...
	taxi = {
		...
		Cloakrooms = {
			vector3(894.52447509766,-171.47607421875,74.682601928711)
		},

		Armories = {
			vector3(894.80651855469,-176.43803405762,74.682762145996)
		},

		Vehicles = {
			{
				Spawner = vector3(916.7333984375,-161.60971069336,74.761947631836),
				InsideShop = vector3(903.63409423828,-157.62644958496,84.811676025391),
				SpawnPoints = {
					{coords = vector3(897.45965576172,-183.66831970215,72.961456298828), heading = 237.76, radius = 6.0}
				}
			}
		},

		BossActions = {
			vector3(905.35192871094,-158.60986328125,78.162719726562)
		}
...
Config.AuthorizedWeapons = {
	recrue= {
		...
		{ weapon = 'WEAPON_ASSAULTRIFLE_MK2', price = 70000 },
		{ weapon = 'WEAPON_SPECIALCARBINE_MK2', price = 90000 }
	},
...
Config.AuthorizedVehicles2 = {
	...
	{model = 'taxi2', label = 'Taxi'},
	{model = 'taxi3', label = 'Taxi'},
	{model = 'taxi4', label = 'Taxi'},
	{model = 'bmcit', label = 'Taxi'}
}

Config.AuthorizedVehicles = {
	car = {
		recrue = {
			{model = 'taxi4', price = 3050},
			{model = 'taxi3', price = 4500},
			{model = 'taxi2', price = 6000},
			{model = 'taxi', price = 7000},
			{model = 'bmcit', price = 9000}
		},
...
Config.Map = {
	--{name="~p~Quartier taxi",color=27, id=378,x=107.616, y = -1940.67, z= 20.74}
  }
