...
TriggerServerEvent('getJob', function(source, mechanic)
	if mechanic then
		local job = 'mechanic'
	end
end)
...
Citizen.CreateThread(function() --Controls
  ...
  registerJobChangeListener()
	...
	while true do
		...
		if ((GetIsControlJustPressed(VEM.KBKey) and GetLastInputMethod(2))) and playerJobName == 'mechanic' or ((GetIsControlJustPressed(VEM.KBKey) and GetLastInputMethod(2))) and IsAdmin then
