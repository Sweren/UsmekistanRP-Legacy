...
function takeHostage()
	...
	if not canTakeHostage then 
		drawNativeNotification("¡Necesitas una pistola con munición para tomar de rehén a alguien!")
	end
...
Citizen.CreateThread(function()
	while true do 
		if holdingHostage then
			...
			DrawText3D(playerCoords.x,playerCoords.y,playerCoords.z,"Presiona [G]para lanzarlo(a), [H] para asesinarlo(a)")
