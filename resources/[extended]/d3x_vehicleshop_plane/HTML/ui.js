...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Precio: <b>`+car.price+`T$</b></p>
                                    </div>
    ...
    $("#body").on('click', ':button', function () {
        ...
        if($(this).data('value') == "buy")
            $.post('http://d3x_vehicleshop_plane/BuyVehicle', JSON.stringify({model: $(this).data('model')}));
        else if($(this).data('value') == "test-drive")
            $.post('http://d3x_vehicleshop_plane/TestDrive', JSON.stringify({model: $(this).data('model')}));
    });
