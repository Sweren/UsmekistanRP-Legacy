...
local _baseWheelPos = vector3(1111.05, 229.81, -51.38)
local Keys = {
...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        Citizen.CreateThread(function()
            ...
            local vehicle = CreateVehicle(carmodel, 1100.39, 220.09, -51.59, 0.0, false, false)
...
Citizen.CreateThread(function()
	while true do
        ...
        if(GetDistanceBetweenCoords(coords, _wheelPos.x, _wheelPos.y, _wheelPos.z, true) < 1.5) and not _isRolling then
            ESX.ShowHelpNotification("Presione E para probar su suerte con la ruleta ($50,000)")
