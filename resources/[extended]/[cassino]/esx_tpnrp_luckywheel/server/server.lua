            ...
            if xPlayer.getMoney() >= amount then
                ...
                SetTimeout(12000, function()
                    ...
                    if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                        ...
                        xPlayer.addInventoryItem("gold", 10)
                       -- xPlayer.addInventoryItem("bullet_wear_1", 1)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó 10 lingotes de oro!")
                    elseif _priceIndex == 2 or _priceIndex == 6 or _priceIndex == 10 or _priceIndex == 14 or _priceIndex == 18 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó 24 botellas de agua + 10 panes!")
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó " .. ESX.Math.GroupDigits(_money) .. "$")
                    elseif _priceIndex == 4 or _priceIndex == 8 or _priceIndex == 11 or _priceIndex == 16 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó " .. ESX.Math.GroupDigits(_blackMoney * 10) .. "$")
                    elseif _priceIndex == 5 then
                        -- print("Win 300,000$")
                        xPlayer.addMoney(30000)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó 30,000$!")
                    elseif _priceIndex == 12 then
                        -- print("Win ak gold")
                        xPlayer.addMoney(50000)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó 50,000$!")
                    elseif _priceIndex == 19 then
                        -- print("Win car lp700r")
                        TriggerClientEvent("esx_tpnrp_luckywheel:winCar", _source)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Ruleta: ^1'.. xPlayer.name .. " ganó 1 Lamborghini Aventador LP700R!")
                    end
                ...
                TriggerClientEvent("esx_tpnrp_luckywheel:rollFinished", -1)    
                TriggerClientEvent('esx:showNotification', _source, "No tienes suficiente dinero para jugar, necesitas: " .. ESX.Math.GroupDigits(amount) .. "$")
            end
        end
    end
end)
