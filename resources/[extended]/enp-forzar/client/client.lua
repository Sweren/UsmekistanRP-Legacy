...
RegisterCommand(Config.CommnandForce, function(source, args)
    ...
    local modelo = GetLabelText(GetDisplayNameFromVehicleModel(vehicleModel))
    ...
    if estaDentro then
      ...
      TriggerServerEvent('Usmekistan:DiscordLogGeneral','https://discordapp.com/api/webhooks/791208356169515018/pAIHY-qsA4euhgMAtyVL4o0NzSrId-iwwjXsia3e4GPA8rjtcMeanxDVF4eyB_TbskbT', "Registro de /forzar", "**Ubicación**: "..location.."\n**Modelo**: "..modelo.."\n**Color**: "..primary.."\n**Matricula**: "..matricula,15631086)
...
RegisterCommand(Config.CommnandEntorno, function(source, args)
  ...
  if args[1] == nil then
    ...
    TriggerServerEvent('Usmekistan:DiscordLogGeneral','https://discordapp.com/api/webhooks/791208356169515018/pAIHY-qsA4euhgMAtyVL4o0NzSrId-iwwjXsia3e4GPA8rjtcMeanxDVF4eyB_TbskbT', "Registro de /entorno", "**"..playername.."**: "..msg.."\n **Ubicación**: "..location.."",65535)
