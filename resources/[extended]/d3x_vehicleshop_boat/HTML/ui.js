...
$(document).ready(function(){
    ...
    $("#body").on('click', ':button', function () {
        ...
        if($(this).data('value') == "buy")
            $.post('http://d3x_vehicleshop_boat/BuyVehicle', JSON.stringify({model: $(this).data('model')}));
        else if($(this).data('value') == "test-drive")
            $.post('http://d3x_vehicleshop_boat/TestDrive', JSON.stringify({model: $(this).data('model')}));
    });
