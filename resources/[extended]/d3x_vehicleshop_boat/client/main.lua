...
Citizen.CreateThread(function ()
	...
	ESX.TriggerServerCallback('d3x_vehicleshop_boat:getVehicles', function (vehicles)
		Vehicles = vehicles
	end)
	Citizen.Wait(1000)
	ESX.TriggerServerCallback('d3x_vehicleshop_boat:getCategories', function (categories)
...
RegisterNetEvent('d3x_vehicleshop_boat:sendCategories')
AddEventHandler('d3x_vehicleshop_boat:sendCategories', function (categories)
	Categories = categories
end)

RegisterNetEvent('d3x_vehicleshop_boat:sendVehicles')
AddEventHandler('d3x_vehicleshop_boat:sendVehicles', function (vehicles)
	Vehicles = vehicles
end)
...
RegisterNUICallback('BuyVehicle', function(data, cb)
	...
	if VIP == 1 then
		...
		ESX.TriggerServerCallback('d3x_vehicleshop_boat:buyVehicle', function(hasEnoughMoney)
			exports['mythic_notify']:PersistentHudText('END','waiting')
			...
			if hasEnoughMoney then
				...
				ESX.Game.SpawnVehicle(model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
					...
					if Config.EnableOwnedVehicles then
						TriggerServerEvent('d3x_vehicleshop_boat:setVehicleOwned', vehicleProps, carName)
					end
...
AddEventHandler('d3x_vehicleshop_boat:hasEnteredMarker', function (zone)
...
AddEventHandler('d3x_vehicleshop_boat:hasExitedMarker', function (zone)
	if not IsInShopMenu then
		...
		if CurrentAction == nil then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'resell_vehicle' then
					...
					ESX.TriggerServerCallback('d3x_vehicleshop_boat:resellVehicle', function(vehicleSold)
