Config = {}
	...
	Config.FishPrice = {a = 29, b = 32} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 110, b = 130} --Will get dirty money
	Config.SharkPrice = {a = 290, b = 310} --Will get dirty money
