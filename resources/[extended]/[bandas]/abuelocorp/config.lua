...
Config.abuelocorpStations = {
	...
	abuelocorp = {
		...
		Armories = {
			vector3(-353.02258300781,6236.0146484375,1.488817214966)
		},

		Vehicles = {
			{
				Spawner = vector3(-361.00598144531,-122.36546325684,38.696048736572),
				InsideShop = vector3(-358.83966064453,-87.999946594238,45.570091247559),
				SpawnPoints = {
					{coords = vector3(-369.61587524414,-109.72695159912,37.870780944824), heading = 69.72, radius = 4.0}
				}
			}
		},

		BossActions = {
			vector3(-346.92642211914,-133.47261047363,39.009620666504)
		}
...
Config.AuthorizedVehicles = {
	car = {
		recruit = {
			{model = 'towtruck', price = 3850},
			{model = 'towtruck2', price = 2050},
		},
...
Config.Map = {
	--{name="~p~Quartier abuelocorp",color=27, id=378,x=107.616, y = -1940.67, z= 20.74}
  }