...
Config.royalreapersStations = {
	...
	royalreapers = {
		...
		Armories = {
			vector3(976.76940917969,-103.79774475098,74.845184326172)
		},

		Vehicles = {
			{
				Spawner = vector3(971.21356201172,-116.05107116699,74.353134155273),
				InsideShop = vector3(975.38647460938,-140.92370605469,74.230590820312),
				SpawnPoints = {
					{coords = vector3(966.70538330078,-122.5764465332,73.544479370117), heading = 129.02, radius = 4.0}
				}
			}
		},

		BossActions = {
			vector3(986.11560058594,-92.409378051758,74.846168518066)
		}
...
Config.AuthorizedVehicles = {
	car = {
		recruit = {
			{model = 'dubsta3', price = 12850},
			{model = 'sanctus', price = 3050},
			{model = 'trophytruck', price = 9500},
			{model = 'manchez', price = 5000}
		},
...
Config.Map = {
	--{name="~p~Quartier royalreapers",color=27, id=378,x=107.616, y = -1940.67, z= 20.74}
  }