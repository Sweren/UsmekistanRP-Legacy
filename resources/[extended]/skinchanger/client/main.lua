...
function ApplySkin(skin, clothes)
	...
	if Character['mom'] == nil or Character['dad'] == nil then Character['mom'],Character['dad'] = Character['face'],Character['face'] end 

	if Character['face_md_weight'] == nil then Character['face_md_weight'] = '50' end
    if Character['skin_md_weight'] == nil then Character['skin_md_weight'] = '50' end 
    

        -- Face Blend
        local weightFace = Character['face_md_weight'] / 100 + 0.0
        local weightSkin = Character['skin_md_weight'] / 100 + 0.0

	SetPedHeadBlendData(playerPed, Character['mom'], Character['dad'], 0, Character['mom'], Character['dad'], 0, weightFace, weightSkin, 0.0, false)
	...
	SetPedHeadOverlayColor		(playerPed, 10, 1,	Character['chest_3'], Character['chest_4'])														-- Torso Color
	...
	--if Character['neckarm_1'] ~= nil and Character['neckarm_1'] ~= -1 or Character['neckarm_1'] == 0 then 
	--	SetPedComponentVariation	(playerPed, 7,		Character['neckarm_1'],			Character['neckarm_2'], 2)					-- chain
	--else
	...
	if Character['ears_1'] == -1 then
		...
		SetPedPropIndex			(playerPed, 2,		Character['ears_1'],			Character['ears_2'], 2)					-- Watches
	end

	if Character['lefthand_1'] == -1 then
		ClearPedProp(playerPed, 6)
	else
		SetPedPropIndex			(playerPed, 6,		Character['lefthand_1'],			Character['lefthand_2'], 2)					-- Watches
	end

	if Character['righthand_1'] == -1 then
		ClearPedProp(playerPed, 6)
	else
		SetPedPropIndex			(playerPed, 7,		Character['righthand_1'],			Character['righthand_2'], 2)					-- Watches
	end

	--[[ if Character['neckarm_1'] == -1 then
		ClearPedProp(playerPed,	7)
	else
		SetPedPropIndex			(playerPed, 7,		Character['neckarm_1'],		Character['neckarm_2'], 2)				-- Bracelets
	end ]]
end
