    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
        {label = 'Rumpo RCN', value = 'rumpo'},
        {label = 'Dodge Durango RCN', value = 'srt2018'},
            }
...
ESX.UI.Menu.CloseAll()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'factu_weazelnews_actions',
    {
      ...
      align    = 'right',
      elements = {
        {label = '[ 📝 | 💲  ] Facturas', value = 'facture_client'},
        {label = '[ 🎥 | 🎤 ] Micro / Cámara',   value = 'menucam'}       
      },
    },
...
function openMenucam()
    ...
    align = 'right',
		css      = 'menu_perso',		
		elements = {
			{label = '| 🎥 | Activar/Desactivar Cámara', value = 'Cam'},
			{label = '| 🎤 | Activar/Desactivar Micro', value = 'Mic'},
		}
	},
	function(data, menu)
