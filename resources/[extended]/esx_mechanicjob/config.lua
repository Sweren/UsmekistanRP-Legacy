...
Config.NPCJobEarnings             = { min = 80, max = 120 }
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -206.91, y = -1331.43, z = 33.89 }, 
	...
	Garage = {
		Pos   = { x = -196.49, y = -1318.97, z = 30.08 }, 
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 255, g = 255, b = 255 },
		Type  = 1
	},
	...
	Craft = {
		Pos   = { x = -198.32, y = -1315.49, z = 30.08}, 
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 255, g = 255, b = 255 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -184.10, y = -1286.42, z= 31.29 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -189.89, y = -1268.01, z = 30.24 },
