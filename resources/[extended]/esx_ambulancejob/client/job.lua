				...
				if closestPlayer == -1 or closestDistance > 1.0 then
					if data.current.value == 'object_spawner' then
					   ...
					   ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions_spawn', {
						   ...
						   align    = 'right',
						   elements = {
							   {label = 'Camilla', value = 'v_med_emptybed'},
							   --{label = 'Camilla',  value = 'prop_ld_binbag_01'}
						   }
...
function OpenCloakroomMenu()
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'citizen_wear' then
			...
			TriggerServerEvent('esx_policejob:removeItem','diving_gear')
		...
		elseif data.current.value == 'ambulance_wear' then
			...
			TriggerServerEvent('esx_policejob:giveItem','diving_gear',2)
			ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
				if skin.sex == 0 then
