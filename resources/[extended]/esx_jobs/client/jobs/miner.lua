			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 14, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 5,
					requires = "gold",
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 30, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 15,
					requires = "diamond",
