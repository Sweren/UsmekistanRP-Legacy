...
-- Garage
  ...
  ['vehicleshop_title'] = 'Tienda Sheriff',
  ...
  ['being_searched'] = 'estás siendo ~y~registrado~s~ por ~b~Sheriff~s~',
  -- Vehicle interaction
  ...
  ['estandar'] = 'Uniforme Sheriff',
  ['operativos'] = 'Uniforme Sheriff Civil',
  ['casco'] = 'Casco',
