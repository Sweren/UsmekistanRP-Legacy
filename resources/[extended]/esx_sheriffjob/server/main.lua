...
RegisterNetEvent('esx_sheriffjob:getStockItem')
...
RegisterNetEvent('esx_sheriffjob:putStockItems')
...
RegisterServerEvent('esx_sheriffjob:giveRadio')
AddEventHandler('esx_sheriffjob:giveRadio', function()
		local XPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_sheriffjob:removeRadio')
AddEventHandler('esx_sheriffjob:removeRadio', function()
	local XPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('esx_sheriffjob:addLicense')
AddEventHandler('esx_sheriffjob:addLicense', function(target)
	local _source = source
