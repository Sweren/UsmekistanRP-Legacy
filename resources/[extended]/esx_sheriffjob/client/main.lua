...
function setUniform(uniform, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		if uniformObject then
			...
			if uniform == 'bullet_wear' or uniform == 'operativos' then
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		--{label = _U('polcivil'), uniform = 'polcivil'},
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'citizen_wear' then
			exports["rp-radio"]:RemovePlayerAccessToFrequencies(2, 3, 6, 7)
			exports["rp-radio"]:SetRadio(0)
			TriggerServerEvent('esx_sheriffjob:removeRadio')
		...
		if Config.EnableESXService and data.current.value ~= 'citizen_wear' then
			exports["rp-radio"]:GivePlayerAccessToFrequencies(2, 3, 6, 7)
			exports["rp-radio"]:SetRadio(1)
			TriggerServerEvent('esx_sheriffjob:giveRadio')
			local awaitService
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'license2' then
						TriggerServerEvent('esx_sheriffjob:addLicense',GetPlayerServerId(closestPlayer))
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 167) and not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'sheriff' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions') then
			if not Config.EnableESXService then
