...
Citizen.CreateThread(function()
	...
	for _,new_zone in pairs(config.zones) do
		...
		zone = AddBlipForArea(new_zone.coords.x, new_zone.coords.y, new_zone.coords.z, new_zone.zone.width, new_zone.zone.height)
		SetBlipSprite(zone, 9)
		SetBlipAlpha(zone, 100)
		SetBlipColour(zone, new_zone.zone.color)
		SetBlipRotation(zone, new_zone.zone.rotation)
		SetBlipDisplay(zone, 3)
