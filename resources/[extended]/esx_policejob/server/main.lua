...
AddEventHandler('esx_policejob:revive', function(playerId)
...
RegisterServerEvent('route68_police_job:grzywna')
AddEventHandler('route68_police_job:grzywna', function(cel, count)

	local xPlayer = ESX.GetPlayerFromId(source)
	local xTarget = ESX.GetPlayerFromId(cel)

	xTarget.removeAccountMoney('bank', count)
	--xPlayer.addMoney(count)
	TriggerClientEvent("pNotify:SendNotification", cel, {text = 'Se ha pagado una multa por la cantidad de: $'..count})
end)

RegisterServerEvent('esx_policejob:giveRadio')
AddEventHandler('esx_policejob:giveRadio', function()
		local XPlayer = ESX.GetPlayerFromId(source)

		local qtty = XPlayer.getInventoryItem('radio').count
		if qtty > 1 then
		...
		exports["mumble-voip"]:SetPlayerRadioName(source,XPlayer.getName(source))
end)
RegisterServerEvent('esx_policejob:removeRadio')
AddEventHandler('esx_policejob:removeRadio', function()
	local XPlayer = ESX.GetPlayerFromId(source)

	local qtty = XPlayer.getInventoryItem('radio').count
	XPlayer.removeInventoryItem('radio', qtty)

end)

RegisterServerEvent('esx_policejob:giveItem')
AddEventHandler('esx_policejob:giveItem', function(item, count)
		local XPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_policejob:removeItem')
AddEventHandler('esx_policejob:removeItem', function(item)
	local XPlayer = ESX.GetPlayerFromId(source)
