...
function OpenShopMenu()
	...
	for i=1, #Categories, 1 do
		...
		for j=1, #categoryVehicles, 1 do
			...
			table.insert(options, ('%s <span style="color:green;"><b>%s</b></span>'):format(vehicle.name, _U('generic_shopitem', ESX.Math.GroupDigits(vehicle.price))))
		end
...
TriggerEvent('chat:addSuggestion', '/transferirvehiculo', 'Transferir vehículo a otra persona', {
    { name="ID", help="ID de jugador destino" },
    { name="Placa", help="Placa del vehículo" }
})