...
drivingStyle = 787260        -- Default Value: 786603
...
mechPeds = {
                ...
                [1] = {name = "Médico Autónomo", icon = "CHAR_CALL911", model = "s_m_m_doctor_01", vehicle = 'faggio', colour = 111, 
                                ['lines'] = {
                                        "Cuídate, recuperate pronto.",}},
