...
Config.Strings = {
	ExitVehicle = "Salga del vehiculo para repostar",
    EToRefuel = "Presione ~g~E ~w~para repostar el vehiculo",
    JerryCanEmpty = "El bidon esta vacio",
    FullTank = "El tanque esta lleno",
    PurchaseJerryCan = "Presione ~g~E ~w~para comprar un bidón ~g~$" .. Config.JerryCanCost,
    CancelFuelingPump = "Presione ~g~E ~w~para cancelar el repostamiento",
    CancelFuelingJerryCan = "Presione ~g~E ~w~para cancelar el repostamiento",
...
if not Config.UseESX then
    Config.Strings.PurchaseJerryCan = "Presione ~g~E ~w~para agarrar un bidón"
    Config.Strings.RefillJerryCan = "Presione ~g~E ~w~ para rellenar el bidón"
end
