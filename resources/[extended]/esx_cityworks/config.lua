...
Config.nameJobLabel               = "Servicios Públicos"
Config.platePrefix                = "SPUBLC"
Config.Locale                     = 'fr'

Config.Vehicles = {
	Truck = {
		Spawner = 1,
		Label = 'Camión de energía y agua',
		Hash = "boxville",
		Livery = 0,
		Trailer = "none",
	}	
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = Config.nameJobLabel..": Comenzar Trabajo",
	hint = 'Presiona ~INPUT_CONTEXT~ para acceder al locker',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Presiona ~INPUT_CONTEXT~ para elegir un vehículo',
  },
  ...
  VehicleDeleter = {
	...
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel..": Regresar Vehículo",
	hint = 'Presiona ~INPUT_CONTEXT~ para regresar vehículo',
  },
  ...
  Vente = {
	...
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipName = Config.nameJobLabel..": Pago",

	ItemTime = 500,
	ItemDb_name = "pay_works",
	ItemName = "Boleta de Pago",
	ItemMax = 50,
	ItemAdd = 1,
	ItemRemove = 1,
	ItemRequires = "pay_works",
	ItemRequires_name = "Boleta de Pago",
	ItemDrop = 100,
	ItemPrice  = 380,
	hint = 'Presiona ~INPUT_CONTEXT~ para abonar tus Boletas de Pago',
  },
