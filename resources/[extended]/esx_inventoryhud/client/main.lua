            ...
            if Config.IncludeAccounts and accounts ~= nil then
                for key, value in pairs(accounts) do
                    if not shouldSkipAccount(accounts[key].name) then
                        local canDrop = false
                        if accounts[key].name == 'money' then canDrop = true end
                        if accounts[key].name == 'black_money' then canDrop = true end
                        if accounts[key].name == 'tricoins' then canDrop = false end
