...
Config.ExcludeAccountsList = {"bank", "money", "tricoins"} --  DONT TOUCH!
Config.OpenControl = 317 -- Key for opening inventory. Edit html/js/config.js to change key for closing it.
Config.CloseControl = 317
